...
<a href="https://developer.apple.com/swift"><img src="https://img.shields.io/badge/swift3-compatible-blue.svg?style=flat" alt="Swift 3 compatible" /></a>
...
```ogdl
github "algolia/instantsearch-ios" ~> 1.0.0
```
